...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($name === '' || $price === '' || $category_id === '') {
    ...
    $stmt = $pdo->prepare("INSERT INTO menu_items (name, price, description, category_id) VALUES (?, ?, ?, ?)");
...
<head>
  ...
  <title>Add Item | Taiyo Admin</title>
  <link
    ...
    <main class="page-body">
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Add a new dish to your menu</p>
        </div>
      </div>
        ...
        <form action="add-item.php" method="POST">
          ...
          <div class="form-grid">
            ...
            <div class="form-field">
              ...
              <input id="name" name="name" type="text" placeholder="e.g. Tonkotsu Ramen" required />
            </div>

            <div class="form-field">
              <label for="price">Price (€)</label>
              <input id="price" name="price" type="number" step="0.01" min="0" placeholder="e.g. 14.50" required />
            </div>
            ...
            <div class="form-field form-field-full">
              ...
              <textarea id="description" name="description" placeholder="Short description of the dish..."
                rows="4"></textarea>
            </div>
